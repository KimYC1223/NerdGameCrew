...
module.exports = function (app) {
    ...
    app.get('/metrics', (req,res) => { 
      ...
      getServerStatus().then( () => {
        res.writeHead(200);
        res.end('minecraft_server 1'); 
      }).catch(() => {
        res.writeHead(200);
        res.end('minecraft_server 0');  
      })
    })
    //===================================================================================================================================
    ...
    //    홈 화면
    //===================================================================================================================================
    app.get('/', (req,res) => { res.render(__dirname+'/Web/Main/HTML/index.html') })
    //===================================================================================================================================
    ...
    //    팰월드
    //===================================================================================================================================
    app.get('/PalWorld', (req,res) => {
      res.render(__dirname+'/Web/PalWorld/HTML/index.ejs')
    })
